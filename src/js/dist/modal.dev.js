...
var sx_plugin_location_modal = document.currentScript.getAttribute('sx_plugin_location');
/*
*   Modal Options
*/
...
jQuery(document).on('click', '[sx-minimize-modal]', function () {
  jQuery('[sx-modal-uuid="' + jQuery(this).attr('sx-minimize-modal') + '"]').hide(); // <span sx-remove-modal="'+jQuery(this).attr('sx-minimize-modal')+'">Sluiten</span>
...
var sx_confirm_modal = function sx_confirm_modal(text, btn_uuid) {
...
var sx_modal_check = function sx_modal_check() {
