...
(function () {
    ...
    this.set = function (e) {
      ...
      if (t.$isMultiLine) var o = n.length,
        ...
        var l = t.match(n[o - 1])[0].length,
            c = new s(r, a, r + o - 1, l);
        n.offset == 1 ? (c.start.row--, c.start.column = Number.MAX_VALUE) : _u && (c.start.column += _u);
        if (i(c)) return !0;
      };else if (t.backwards) var u = function u(e, t, s) {
        var o = r.getMatchOffsets(e, n);

        for (var u = o.length - 1; u >= 0; u--) {
          if (i(o[u], t, s)) return !0;
        }
      };else var u = function u(e, t, s) {
        var o = r.getMatchOffsets(e, n);
  ...
  u.prototype = o.prototype, function () {
    function e(e) {
      return _typeof(e) == "object" && e.bindKey && e.bindKey.position || 0;
    }
